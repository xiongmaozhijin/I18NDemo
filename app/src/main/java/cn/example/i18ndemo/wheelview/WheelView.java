package cn.example.i18ndemo.wheelview;
...
public class WheelView extends View {
     ...
     */
    private static final int VALUE_TEXT_COLOR = 0xFFFC381D;

    /**
     * Items text color
     */
    private static final int ITEMS_TEXT_COLOR = 0xFFA7A8AD;
    ...
    private void initResourcesIfNecessary() {
        ...
        if (labelPaint == null) {
            int size = (int) getResources().getDimension(R.dimen.wheel_txv_label_size);
            labelPaint = new TextPaint(Paint.ANTI_ALIAS_FLAG);
            labelPaint.setTextSize(size);
            labelPaint.setShadowLayer(0.1f, 0, 0.1f, Color.parseColor("#FFA7A8AD"));
            labelPaint.setColor(Color.parseColor("#FFA7A8AD"));
        }
    }
    ...
    private int getMaxTextLength() {
        ...
        int adapterLength = adapter.getMaxLength();
        if (adapterLength > 0) {
    ...
    private void createLayouts(int widthItems, int widthLabel) {
        ...
        if (widthLabel > 0) {
            if (labelLayout == null || labelLayout.getWidth() > widthLabel) {
                labelLayout = new StaticLayout(label, labelPaint, widthLabel, Layout.Alignment.ALIGN_CENTER, 1, ADDITIONAL_ITEM_HEIGHT, false);
            } else {
    ...
    protected void onDraw(Canvas canvas) {
        ...
        if (itemsWidth > 0) {
            canvas.save();
            canvas.translate(PADDING, -ITEM_OFFSET);// Skip padding space and hide a part of top and bottom items
            drawItems(canvas);
            drawValue(canvas);
            canvas.restore();
        }
    ...
    private void drawValue(Canvas canvas) {
        ...
        if (labelLayout != null) {
            int txtOffset = 0;
            Paint.FontMetrics fM1 = valuePaint.getFontMetrics();
            Paint.FontMetrics fM2 = labelPaint.getFontMetrics();

            float h1 = fM1.top + fM1.bottom;
            float h2 = fM2.top + fM2.bottom;


            canvas.save();
            canvas.translate(itemsLayout.getWidth() + LABEL_OFFSET, bounds.top - (h1 - h2));
